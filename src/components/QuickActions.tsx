...
export function ActionButton({ action }: { action: ActionSummary }) {
  ...
  return (
    <button
      ...
      className={`bg-surface grid h-full w-full place-items-center border transition-colors disabled:opacity-50 ${tone} ${
